...
class CustomerRegisterFormTest {
    ...
    public void regCustomerNormal(){
        CustomerRegisterForm customerRegisterForm = new CustomerRegisterForm("id123123", "pw123123","pw123123", "hyunwoo"
                ,20,null,"ex@naver.com");
    ...
    public void regCustomerNameOver20(){
        CustomerRegisterForm formNameOver20 = new CustomerRegisterForm("id123123","pw123123","pw123123",
                "name123123123123123123123123123123",20 ,null,"ex@naver.com");
    ...
    public void regCustomerWithoutEmail() {
        CustomerRegisterForm formWithoutEmail = new CustomerRegisterForm("id123", "pw123", "pw123", "name123", 20, null, "");
        Set<ConstraintViolation<CustomerRegisterForm>> result = validator.validate(formWithoutEmail);
        assertThat(result.size()).isEqualTo(1);
        for (ConstraintViolation<CustomerRegisterForm> v : result) {
            assertThat(v.getMessageTemplate()).isEqualTo("이메일을 입력해주세요.");
        }
    }
}